...
$sql = mysql_query("SELECT * FROM MATERIA,NOTAS WHERE NOMBRE_M='$MATERIA' AND MATERIA.GRADO='$GRADO' AND NOTAS.GRADO='$GRADO' AND NOTAS.PERIODO='$PERIODO' AND NOTAS.ANO='$AÑO' AND NOTAS.ID_MAESTRO='$ID' ",$link);
...
<table width="588" border="1">
  ...
  <tr> 
    <td colspan="5" align="center"><span style="color=#003;"><strong>GRADO:</strong> 
      <?php echo $GRADO;  ?>
      </span></td>
    <td colspan="6" align="center"><strong>MATERIA:<span style="color=#003;"> 
      </span></strong><span style="color=#003;"> 
      <?php echo $MATERIA;  ?>
      </span></td>
  </tr>
  <tr> 
    <td colspan="5" align="center"><strong>PERIODO:</strong><span style="color=#003;"> 
      <?php echo $PERIODO;  ?>
      </span></td>
    <td colspan="6" align="center"><strong>ANO</strong>:<span style="color=#003;"> 
      <?php echo $AÑO;  ?>
      </span></td>
  </tr>
  <tr> 
    <td colspan="11"><strong>MAESTRO:</strong> 
