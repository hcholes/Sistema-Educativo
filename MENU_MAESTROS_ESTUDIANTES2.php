...
?>
            ...
            <ul id="subnavi">
               ...
               <li><a href="VER_NOTAS_MAESTROS1.php">Notas</a></li>
                ...
                <li><a href="MENU_MAESTROS_ACT_VER.php">Actividades y Notas</a></li>			   				
                <li><a href="MENU_MAESTROS_MATERIAS.php">Materias Asigandas</a></li>				
				<li class="active"><a href="MENU_MAESTROS_ESTUDIANTES.php">Estudiantes Asignados</a></li>
    ...
    <td width="57%"><div align="center"><font size="2"><strong><font color="#FFFFFF">NOMBRE</font></strong></font></div></td>
      ...
      <div align="center">
        <p>&nbsp;</p>
        <p><a href="/reporte_ESTUDIANTES_MAESTROS.php"><img src="/imprimir.fw.png" width="150" height="40" border="0" /></a></p>
      </div>
      <h1 align="center"><a href="/MENU_MAESTROS_ESTUDIANTES.php"><img src="regresar.fw.png" alt="" width="70" height="70" /></a></h1>
    </div>
  </div>
  <div id="footer">
