...
?>
    	...
    	<div id="right-part">
       	  ...
       	  <form action="menu_administrador_act_ELI2.php" method="post" enctype="multipart/form-data">
       	  <p>
        ...
        <table width="73%" height="152" border="0" align="center">
          <tr> 
            <td width="50%" height="26" align="left"><div align="right"><strong>Materia: 
                </strong></div></td>
            <td width="50%" align="center"><div align="left"><strong> 
		...
		?>
          ...
          <tr> 
            <td colspan="2"> <div align="center"> 
                <input type="submit" name="VER" id="VER3" value="Eliminar" />
              </div></td>
          </tr>
        </table>
       	  </form>
