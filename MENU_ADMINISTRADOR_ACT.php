...
?>
            ...
            <ul id="subnavi">
                ...
                <li align="center"><a href="MENU_ADMINISTRADOR_ACT_AD.php">Agregar Mensaje</a></li>
                <li><a href="MENU_ADMINISTRADOR_ACT_MOD.php">Modificar Mensaje</a></li>
		...
		?>
		  ...
		  $ID=$_SESSION['ID1'];
		  		  $result = mysql_query("SELECT DISTINCT NOMBRE_M FROM MATERIA", $link); 
		   while ($row = mysql_fetch_array($result)){ 
		...
		?>
       	      ...
       	      <tr>
   	            ...
   	            <input type="text" name="FECHA_CREACION" id="FECHA_CREACION" VALUE=<?php echo date("m/d/Y"); ?> ></td>
   	        </tr>
       	      <tr>
      ...
      <p align="center"><a href="MENU_ADMINISTRADOR.php"><img src="regresar.fw.png" alt="" width="70" height="70" /></a></p>
