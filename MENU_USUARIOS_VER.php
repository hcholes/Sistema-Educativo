...
?>
      ...
      <form action="MENU_USUARIOS_VER2.php" method="post" enctype="multipart/form-data">
      <p align="center">Tipo de Usuario: <strong>
        <select name="TIPO">
          <?php 
		  ...
		  $ID=$_SESSION['ID1'];
		  		  $result = mysql_query("SELECT DISTINCT TIPO FROM ENTRADA ORDER BY TIPO ASC", $link); 
...
<div align="center"><font color="#FFFFFF" size="0"><strong>CONTRASEÑA</strong></font></div></td>
		  ...
		  mysql_select_db("SISTEMA_EDUCATIVO", $link); 
			...
			$result = mysql_query("SELECT * FROM ENTRADA ORDER BY TIPO,ID ", $link); 
			while ($row = mysql_fetch_array($result)){ 
...
$_SESSION['TEMPO']=0;
        ...
        <div align="center"><a href="REPORTE2.PHP"><img src="imprimir.fw.png" alt="" width="150" height="50" /></a></div>
        </form>
