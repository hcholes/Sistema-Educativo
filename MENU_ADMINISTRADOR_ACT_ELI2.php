...
?>
            ...
            <ul id="subnavi">
                ...
                <li class="active"><a href="MENU_ADMINISTRADOR_ACT_ELI.php">Eliminar Mensaje</a></li>
    	...
    	<div id="right-part">
       	  ...
       	  <table width="56%" height="149" border="0" align="center">
                ...
                <?php
				if ($_POST["ID_MAESTRO1"]==""){
				header("Location: /MENU_ADMINISTRADOR_ACT_ELI.php");	
				}
		   ...
		   $sql = "DELETE FROM ACTIVIDADES WHERE ID_MATERIA='$MATERIA' AND PERIODO='$PERIODO' AND ANO='$AÑO'"; 		   $result = mysql_query($sql);
		   if (! $result){
			   echo $sql;
			   exit;
 ...
 echo "PROCESO EXITOSO!";
                ...
                <p align="center"><a href="MENU_ADMINISTRADOR_ACT_eli.php"><img src="regresar.fw.png" alt="" width="70" height="70" /></a></p>
       	        </div></td>
   	          </tr>
   	        </table>
