...
?>
      ...
      <h1 align="center"><img src="documentos_reg.fw.png" width="495" height="60" alt="PROC_MATERIA" /></h1>
       	  ...
       	  <p>
       	    ...
       	    <table width="36%" border="0" align="right">
       	      ...
       	      <tr>
       	        ...
       	        <td><div align="center"><?php echo $_SESSION["GRADO"]; ?></div></td>
   	          </tr>
   	        </table>
       	  </form>
       	  <p align="center">&nbsp;</p>
       	  ...
       	  <p align="left">
       	    <?php
    if ($_POST["MATERIA"]=="") {
	header("Location: /MENU_ESTUDIANTES_VER_DOC.php");
exit(); 
 }
...
?>
      ...
      <p align="center"><a href="MENU_ESTUDIANTES_VER_DOC.php"><img src="regresar.fw.png" alt="" width="70" height="70" /></a></p>
