    ...
    -->            
      ...
      <h1 align="center"><img src="ELIMINAR_RELACION.fw.png" width="495" height="60" alt="PROC_MATERIA" /></h1>
		  ...
		  if (($_POST["estudiante"]=="") or ($_POST["padre"]=="")){
				 header("Location: /MENU_ESTU_PADRE_ELIMINAR.php");
exit();
		}
	   ...
	   $sql = "DELETE FROM estudiante_padre WHERE ID_ESTUDIANTE='$estudiante' AND ID_PADRE='$padre'";
		$result = mysql_query($sql);
	    
      if (! $result){ 
			  echo "no se pudo existe errores";
		   }else{
      ...
      <p align="center"><a href="MENU_ESTU_PADRE_ELIMINAR.php"><img src="regresar.fw.png" alt="" width="70" height="70" /></a></p>
