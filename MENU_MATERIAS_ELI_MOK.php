...
?>
            ...
            <ul id="subnavi">
             ...
             <li><a href="MENU_MATERIAS_VER.php">Ver Materias Creadas</a></li>
                ...
                <li class="active"><a href="MENU_MATERIAS_ELI.php">Eliminar Materias</a></li>
      ...
      <h1 align="center"> <img src="PROC_MATERIA.fw.png" width="480" height="60" alt="PROC_MATERIA" /></h1>
       	  <form id="form1" method="post" action="MENU_ADMINISTRADOR_NOTAS_AD1.php">
        <div align="center">PROCESO EXITOSO! </div>
        <div align="right"></div>
       	    <p>&nbsp;</p>
   	      </form>
       	  <p align="center">
      ...
      <p align="center"><a href="menu_materias_eli.php"><img src="regresar.fw.png" alt="" width="70" height="70" /></a></p>
