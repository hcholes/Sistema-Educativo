...
?>
            ...
            <ul id="subnavi">
                ...
                <li><a href="MENU_ADMINISTRADOR_SUBIR_DOC.php">Subir Documentos</a></li>
                 <li class="active"><a href="MENU_ADMINISTRADOR_ELI_DOC.php">Eliminar Documentos</a></li>
    	...
    	<div id="right-part">
       	  ...
       	  <form action="MENU_ADMINISTRADOR_ELI_DOC2.php" method="post" enctype="multipart/form-data">
       	  <p>
