...
?>
            ...
            <li><a href="MENU_ADMINISTRADOR_DOC_VER.php">Ver Documentos</a></li>
                <li class="active"><a href="MENU_ADMINISTRADOR_SUBIR_DOC.php">Subir Documentos</a></li>
      ...
      <h1 align="center"> <img src="documentos.fw.png" width="495" height="60" alt="PROC_MATERIA" /></h1>
       	  <form action="MENU_ADMINISTRADOR_CARGA_DOC.php" method="post" enctype="multipart/form-data">
       	    <p>
		  ...
		  $ID=$_SESSION['ID1'];
		  		  $result = mysql_query("SELECT DISTINCT NOMBRE_M FROM MATERIA ORDER BY NOMBRE_M", $link); 
		...
		?>
		  ...
		  $ID=$_SESSION['ID1'];
		  $result = mysql_query("SELECT DISTINCT GRADO FROM MATERIA ORDER BY GRADO", $link); 
		   while ($row = mysql_fetch_array($result)){ 
        ...
        <p>&nbsp; </p>
        <p>&nbsp;</p>
        <p align="justify"><strong><font size="2">Se permiten archivos .gif , 
          .jpg , .doc , .docx , .xls , .xlsx , .pdf , zip.</font></strong></p>
        <p align="justify"><br />
          <font size="2"><strong>Tamaño de los archivos deben ser de 104857600 
          bytes máximo.</strong></font></p>
        <p align="justify"><strong><font size="2">Los documentos a subir no debe 
          tener espacios entre las palabras, ni tildes.</font></strong></p>
        <p><br />
