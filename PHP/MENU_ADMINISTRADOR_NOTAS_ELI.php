...
?>
            ...
            <ul id="subnavi">
                ...
                <li><a href="MENU_ADMINISTRADOR_NOTAS_AD.php">Adicionar  Registro de Notas</a></li>
                  <li class="active"><a href="MENU_ADMINISTRADOR_NOTAS_ELI.php">Eliminar  Registro de Notas</a></li>
    	...
    	<div id="right-part">
            ...
            <img src="Procedimiento_notas.fw.png" width="495" height="60" alt="PROC_MATERIA" /></h1>
       	  <form id="form1" method="post" action="ELIMINAR_NOTAS.php">
		...
		?>
		 ...
		 $ID=$_SESSION['ID1'];
		  $result = mysql_query("SELECT DISTINCT ID_ESTUDIANTE FROM NOTAS ", $link); 
          while ($row = mysql_fetch_array($result)){ 
		...
		?>
		 ...
		 $ID=$_SESSION['ID1'];
		  $result = mysql_query("SELECT DISTINCT GRADO FROM NOTAS ORDER BY GRADO", $link); 
          while ($row = mysql_fetch_array($result)){ 
