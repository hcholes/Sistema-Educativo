...
?>
            ...
            <ul id="subnavi">
                ...
                <li class="active"><a href="SUBIR_ARCHIVOS.php">Subir Documentos</a></li>
      ...
      <h1 align="center"> <img src="documentos.fw.png" width="495" height="60" alt="PROC_MATERIA" /></h1>
		...
		?>
       	    ...
       	    <p>&nbsp;</p>
       	    <p> se permiten archivos .gif , .jpg , .doc , .docx , .xls , .xlsx , .pdf , .mp4 , .wmv , .avi , .mpg , .mp3 , .wma.<br />
       	      Tamaño de los archivos deben ser de 100 Mg(102400 Kb) máximo.&quot;; <br />
