...
?>
            ...
            <ul id="subnavi">
                ...
                <li><a href="SUBIR_ARCHIVOS.php">Subir Documentos</a></li>
                 <li><a href="ELIMINAR_DOCUMENTOS.php">Eliminar Documentos</a></li>
...
if (!((strpos($tipo_archivo, "gif") || strpos($tipo_archivo, "jpeg")  || strpos($tipo_archivo, "doc") || strpos($tipo_archivo, "docx") || strpos($tipo_archivo, "pdf") || strpos($tipo_archivo, "xls") || strpos($tipo_archivo, "xlsx") || strpos($tipo_archivo, "avi") || strpos($tipo_archivo, "mpg") || strpos($tipo_archivo, "wmv") || strpos($tipo_archivo, "wma") || strpos($tipo_archivo, "mp3") || strpos($tipo_archivo, "mp4")) && ($tamano_archivo < 104857600))) { 
	...
	echo "Existe error en la extensión o el tamaño del Archivo. <br><br><table><tr><td><li>Verificar el tipo, solo se permiten archivos .gif , .jpg , .doc , .docx , .xls , .xlsx , .pdf , .mp4 , .wmv , .avi , .mpg , .mp3 , .wma<br><li>se permiten archivos de 100 Mg(102400 Kb) máximo.</td></tr></table>"; 
...
?>
      ...
      <p align="center"><a href="SUBIR_ARCHIVOS.php"><img src="regresar.fw.png" alt="" width="70" height="70" /></a></p>
