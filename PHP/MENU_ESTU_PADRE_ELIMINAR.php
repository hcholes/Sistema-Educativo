...
?>
            ...
            <li class="active">
                ...
                <li class="active"><a href="MENU_ESTU_PADRE_ELIMINAR.php">Eliminar Relacion</a></li>
<!--                 <li><a href="MENU_ADMINISTRADOR_ELI_DOC.php">Eliminar Documentos</a></li>
    -->            
      ...
      <h1 align="center"><img src="ELIMINAR_RELACION.fw.png" width="495" height="60" alt="PROC_MATERIA" /></h1>
       	  <form action="MENU_ESTU_PADRE_ELIMINAR2.php" method="post" enctype="multipart/form-data">
       	  <p>
        ...
        <table width="51%" border="0" align="center">
		  ...
		  $ID=$_SESSION['ID1'];
		  		  $result = mysql_query("SELECT DISTINCT ID_ESTUDIANTE FROM estudiante_padre", $link); 
		...
		?>
                ...
                <input name="button" type='button' onclick="AbreVentanaModal()" value="..." />
       	      ...
       	      <tr>
       	        <td><div align="center"><strong>Padre de Familia: </strong> 
		  ...
		  $ID=$_SESSION['ID1'];
		  $result = mysql_query("SELECT DISTINCT ID_PADRE FROM estudiante_padre", $link); 
		   while ($row = mysql_fetch_array($result)){ 
		  echo "<option >".$row['ID_PADRE']."</option>";
		  }
		?>
                </select>
                <strong>
                ...
                <input type="submit" name="VER" id="VER" value="Eliminar" />
   	            </div></td>
   	          </tr>
   	        </table>
       	  </form>
