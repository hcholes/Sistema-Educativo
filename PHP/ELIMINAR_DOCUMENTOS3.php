...
?>
    	...
    	<div id="right-part">
       	  <h1 align="center"><font size="-5"><img src="documentos_eli.fw.png" width="495" height="60" alt="PROC_MATERIA" /></h1>
       	  <form action="VER_DOCUMENTOS2.php" method="post" enctype="multipart/form-data">
       	  <p>
   	        <input type="hidden" name="MAX_FILE_SIZE" value="1000000" />
   	        </p>
              <?php
		   if (($_POST["ARCHIVO"]=="")){
		header("Location: /ELIMINAR_DOCUMENTOS.php");
	exit;
		}
...
$dir = $_SERVER['DOCUMENT_ROOT'] . '/descargas/'.$GRADO."/".$MATERIA."/".$ARCHIVO; 
unlink("$dir");

?>
       	  <p align="center"><strong>El Archivo ha sido Eliminado</strong></p>
       	  </form>
       	  <p align="center">&nbsp;</p>
       	  
      <p align="center"><a href="ELIMINAR_DOCUMENTOS.php"><img src="regresar.fw.png" alt="" width="70" height="70" /></a></p>
