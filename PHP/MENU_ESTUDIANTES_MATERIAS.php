...
?>
            ...
            <ul id="subnavi">
			   ...
			   <li class="active"><a href="MENU_ESTUDIANTES_MATERIAS.PHP">Materias Asignadas</a></li>			   
    ...
    <td width="10%"><div align="center"><font size="2"><strong><font color="#FFFFFF">GRADO</font></strong></font></div></td>
      ...
      <h1 align="center"><a href="/MENU_ESTUDIANTES.php"><img src="INICIO_.fw.png" alt="" width="70" height="70" /></a></h1>
    </div>
  </div>
  <div id="footer">
