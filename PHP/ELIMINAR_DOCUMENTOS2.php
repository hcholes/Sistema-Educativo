...
?>
      ...
      <h1 align="center"><img src="documentos_eli.fw.png" width="495" height="60" alt="PROC_MATERIA" /></h1>
       	  <form action="ELIMINAR_DOCUMENTOS3.php" method="post" enctype="multipart/form-data">
       	  <p>
   	        <input type="hidden" name="MAX_FILE_SIZE" value="1000000" />
   	        </p>
       	    <table width="39%" border="0" align="center">
       	      <tr>
       	        <td><div align="center"><strong>Archivo:
       	              <select name="ARCHIVO">
                      <?php
   if ($_POST["MATERIA"]=="") {
...
while ($archivo = readdir($directorio)){ 
 ...
 echo "<option >"."<a href=$enlace>$archivo<br></a>"."</option>";
