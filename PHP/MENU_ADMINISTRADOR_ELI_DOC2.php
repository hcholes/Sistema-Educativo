...
?>
      ...
      <h1 align="center"><img src="documentos_eli.fw.png" width="495" height="60" alt="PROC_MATERIA" /></h1>
       	  <form action="MENU_ADMINISTRADOR_ELI_DOC3.php" method="post" enctype="multipart/form-data">
       	  <p>
 ...
 if (($_POST["MATERIA"]=="") or ($_POST["GRADO"]=="")) {
				header("Location: /MENU_ADMINISTRADOR_ELI_DOC.php");	
				}
...
?>
      ...
      <p align="center"><a href="MENU_ADMINISTRADOR_ELI_DOC.PHP"><img src="regresar.fw.png" alt="" width="70" height="70" /></a></p>
