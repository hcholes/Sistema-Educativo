...
<body>
 ...
 if (($_POST["MATERIA"]=="") or ($_POST["ESTUDIANTE1"]=="")){
				 header("Location: /MENU_ADMINISTRADOR_NOTAS_ELI.php");
exit();
		}
...
if (! $result){
header("Location: /MENU_ADMINISTRADOR_NOTAS_ELI_MERROR.php");
exit();
}else{
header("Location: /MENU_ADMINISTRADOR_NOTAS_ELI_MOK.php");
exit; 
}
?>
