...
echo $_SESSION['NOM1'];
if ($_POST["MATERIA"]==""){
				header("Location: /MENU_ADMINISTRADOR_ACT_VER.php");	
				}
?>
                <br />
        	</font></h1>
        ...
        <table width="62%" height="330" border="0" align="center">
          ...
          <tr> 
		   ...
		   $result = mysql_query("SELECT FECHA_CREACION FROM ACTIVIDADES WHERE ID_MATERIA='$MATERIA' AND PERIODO='$PERIODO' AND ANO='$AÑO'", $link); 
          ...
          <tr> 
		   ...
		   $result = mysql_query("SELECT comentario FROM ACTIVIDADES WHERE ID_MATERIA='$MATERIA' AND PERIODO='$PERIODO' AND ANO='$AÑO'", $link); 
		   if ($row = mysql_fetch_array($result)){ 
		  echo $row['comentario'];
		  }
				?> </textarea>
          ...
          <tr> 
            <td colspan="4"><div align="center"> 
                <p align="center"><a href="MENU_ADMINISTRADOR_ACT_VER.php"><img src="regresar.fw.png" alt="" width="70" height="70" /></a></p>
              </div></td>
          </tr>
        </table>
