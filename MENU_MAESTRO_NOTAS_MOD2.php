...
?>
            ...
            <ul id="subnavi">
              ...
              <li><a href="VER_NOTAS_MAESTROS1.php">Ver Notas</a></li>
                <li><a href="ADICION_NOTAS.php">Adicionar  Nota</a></li>
                 <li><a href="MENU_MAESTRO_NOTAS_ELI.php">Eliminar Nota</a></li>
                 <li class="active"><a href="MENU_MAESTRO_NOTAS_MOD.php">Modificar Nota</a></li>
      ...
      <?php
		...
		header("Location: /MENU_MAESTRO_NOTAS_MOD.php");
	exit;
		}
      ...
      <form id="form1" method="post" action="MODIFICAR_NOTA_MAESTRO.php">
        ...
        <p align="center"><a href="MENU_MAESTRO_NOTAS_MOD.PHP"><img src="regresar.fw.png" alt="" width="70" height="70" /></a></p>
   	      </form>
