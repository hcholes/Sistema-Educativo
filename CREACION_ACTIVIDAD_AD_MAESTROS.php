 ...
 <div align="center">
   <p>
     <?php
		   ...
		   if (($_POST["MATERIA"]=="") or ($_POST["GRADO"]=="") or ($_POST["PERIODO"]=="") or ($_POST["ANO"]=="")) {

header("Location: /MENU_MAESTROS_ACT_AD_MERROR.php");
exit();
...
header("Location: /MENU_MAESTROS_ACT_AD_MOK.php");
exit; 
}
}
?>
