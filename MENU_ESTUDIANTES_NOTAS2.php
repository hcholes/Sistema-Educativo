  ...
  ?>
      ...
      <table width="98%" border="1">
        <tr bgcolor="#003366">
          ...
          <td bgcolor="#990000">
<div align="center"><font color="#FFFFFF"><strong>NOTA 1 </strong></font></div></td>
...
<div align="center"><font color="#FFFFFF"><strong>NOTA 
			  ...
			  if ($_POST["MATERIA"]=="") {
	header("Location: /MENU_ESTUDIANTES_NOTAS.php");
exit(); 
 }
        ...
        <p align="center"><a href="menu_estudiantes_notas.php"><img src="regresar.fw.png" alt="" width="70" height="70" /></a></p>
