...
?>
    	...
    	<div id="right-part">
       	  ...
       	  <form action="menu_MAESTROS_act_ELI2.php" method="post" enctype="multipart/form-data">
       	  <p>
   	        <input type="hidden" name="MAX_FILE_SIZE" value="1000000" />
       	  </p>
       	  
        <table width="73%" height="104" border="0" align="center">
          <tr> 
            <td width="18%" height="26" align="left"><div align="right"><strong>Grado:</strong></div></td>
