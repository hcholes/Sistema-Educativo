...
?>
      ...
      <p align="right"> 
        <?php
		if (($_POST["MATERIA"]=="") or ($_POST["ESTUDIANTE"]=="")){
		header("Location: /ADICION_NOTAS2.php");
		}
		
		$_SESSION["MATERIA"]=$_POST["MATERIA"];
		$_SESSION["MAESTRO"]=$_SESSION["ID1"];
      ...
      <form id="form1" method="post" action="CREACION_NOTA_MAESTROS.php">
