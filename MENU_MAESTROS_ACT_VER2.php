...
echo $_SESSION['NOM1'];
if ($_POST["MATERIA"]==""){
				header("Location: /MENU_MAESTROS_ACT_VER.php");	
				}
?>
                <br />
        	</font></h1>
            <ul id="subnavi">
             ...
             <li class="active"><a href="MENU_MAESTROS_ACT_VER.php">Ver Mensajes</a></li>
        ...
        <table width="62%" height="330" border="0" align="center">
          <tr>
            <td align="left">&nbsp;</td>
            <td>&nbsp;</td>
            <td align="left"><strong><font color="#990000">FECHA:</font> 
         ...
         $ID=$_SESSION["ID1"];
		   $result = mysql_query("SELECT FECHA_CREACION FROM ACTIVIDADES WHERE ID_MATERIA='$MATERIA' AND GRADO='$GRADO' AND PERIODO='$PERIODO' AND ANO='$AÑO' AND ID_MAESTRO='$ID'", $link); 
		   if ($row = mysql_fetch_array($result)){ 
		  echo "<FONT COLOR=#990000>".$row['FECHA_CREACION']."</FONT>";
		  }
				?>
              </strong></td>
          </tr>
          ...
          <tr> 
            <td height="159" colspan="4"><p><strong>Actividad:</strong> </p>
              <p align="center"> 
		        ...
		        mysql_select_db("SISTEMA_EDUCATIVO", $link); 
         $ID=$_SESSION["ID1"];
		   $result = mysql_query("SELECT comentario FROM ACTIVIDADES WHERE ID_MATERIA='$MATERIA' AND GRADO='$GRADO' AND PERIODO='$PERIODO' AND ANO='$AÑO' AND ID_MAESTRO='$ID'", $link); 
		   if ($row = mysql_fetch_array($result)){ 
		  echo $row['comentario'];
		  }
				?> </textarea>
          ...
          <tr> 
            <td colspan="4"><div align="center"> 
                <p align="center"><a href="MENU_MAESTROS_ACT_VER.php"><img src="regresar.fw.png" alt="" width="90" height="90" /></a></p>
              </div></td>
          </tr>
        </table>
