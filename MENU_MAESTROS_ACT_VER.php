...
?>
    	...
    	<div id="right-part">
       	  ...
       	  <form action="menu_MAESTROS_act_ver2.php" method="post" enctype="multipart/form-data">
       	  <p>
   	        <input type="hidden" name="MAX_FILE_SIZE" value="1000000" />
       	  </p>
       	  
        <table width="64%" height="98" border="0" align="center">
          <tr> 
            <td width="17%" height="26" align="left"><div align="right"><strong>Grado:</strong></div></td>
            <td width="20%" align="center"><div align="left"> 
                <select name="GRADO">
                  <?php 
		  ...
		  $ID=$_SESSION['ID1'];
		  $result = mysql_query("SELECT DISTINCT GRADO FROM ACTIVIDADES WHERE ID_MAESTRO='$ID'", $link); 
		...
		?>
		  ...
		  $ID=$_SESSION['ID1'];
		  		  $result = mysql_query("SELECT DISTINCT ID_MATERIA FROM ACTIVIDADES WHERE ID_MAESTRO='$ID'", $link); 
		   while ($row = mysql_fetch_array($result)){ 
...
datos=showModalDialog('lista_materias_ACTIVIDAD_MAESTRO.php',datos,'status:no;resizable:yes'); 
} 
