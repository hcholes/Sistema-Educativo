...
?>
            ...
            <ul id="subnavi">
               ...
               <li class="active"><a href="VER_NOTAS_MAESTROS1.php">Ver Notas</a></li>
      ...
      <h1 align="center"> <img src="Procedimiento_notas.fw.png" width="495" height="60" alt="PROC_MATERIA" /></h1>
        ...
        <p align="right"><strong>Grado: </strong> 
          <?php
		 $GRADO=$_POST["GRADO"]; 
		  $_SESSION['GRA1']= $GRADO;
		 echo $GRADO;
...
$contador=1;
			$result2 = mysql_query("SELECT * FROM MATERIA,NOTAS WHERE NOMBRE_M='$MATERIA' AND MATERIA.GRADO='$GRADO' AND NOTAS.GRADO='$GRADO'", $link); 
...
if ($row["NOTA1"] <> 0 and $row["NOTA2"]==0 and $row["NOTA3"]==0 and $row["NOTA4"]==0 and $row["NOTA5"]==0 and $row["NOTA6"]==0 and $row["NOTA7"]==0 and 			$row["NOTA8"]==0){
        ...
        <p align="center"><a href="/reporte_NOTAS_MAESTROS.php"><img src="/imprimir.fw.png" width="150" height="50" border="0" /></a></p>
        <p align="center"><a href="VER_NOTAS_MAESTROS1.php"><img src="regresar.fw.png" alt="" width="90" height="90" /></a></p>
   	      </form>
