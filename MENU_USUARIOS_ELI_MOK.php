...
<div id="wrapper">
	<div id="top">
    	...
    	<ul id="topnavi">
        	...
        	<li><a href="CONTACTENOS.PHP">CONTACTENOS</a></li>i>
      </ul>
    </div>
...
?>
            ...
            <ul id="subnavi">
               ...
               <li><a href="MENU_USUARIOS_VER.php">Ver Usuarios</a></li>
                ...
                <li class="active"><a href="MENU_USUARIOS_ELI.php">Eliminar Usuario</a><a href="MENU_MATERIAS_VER.php"></a><a href="#"></a></li>
        ...
        <div align="center">
          <p>PROCESO EXITOSO! </p>
          <p>LA RELACION DEL USUARIO HA SIDO ELIMINADA</p>
          <p>LAS ACTIVIDADES RELACIONADAS A ESTE USUARIO HAN SIDO ELIMINADAS</p>
          <p>LAS MATERIAS ASIGNADAS A ESTE USUARIO HAN SIDO ELIMINADAS</p>
        </div>
        <div align="right"></div>
       	    <p>&nbsp;</p>
   	      </form>
       	  
      <p align="center"><a href="/MENU_USUARIOS_ELI.php"><img src="/regresar.fw.png" width="70" height="70" border="0" /></a> </h1>
      </p>
