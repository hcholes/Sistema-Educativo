...
?>
            ...
            <ul id="subnavi">
                <li class="active">
                  <div align="center">Menu principal</div>
                     ...
                     <li class="active"><a href="MENU_ADMINISTRADOR_DOC_VER.php">Ver Documentos</a></li>
    	...
    	<div id="right-part">
       	  ...
       	  <form action="MENU_ADMINISTRADOR_DOC_VER2.php" method="post" enctype="multipart/form-data">
       	  <p>
      ...
      <p align="center"><a href="MENU_ADMINISTRADOR_DOC.php"><img src="regresar.fw.png" alt="" width="70" height="70" /></a></p>
